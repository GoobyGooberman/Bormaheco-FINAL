...
urlpatterns = [
    ...
    url(r'^equipmentdetailsfinance(?P<pk>\d+)', views.get_fi_equipment, name='getfiequipment'),

    url(r'^dispatch/(?P<pk>\d+)', views.dispatch, name='dispatch'),

    url(r'^early_dispatch/(?P<pk>\d+)', views.early_dispatch, name='early_dispatch'),

    url(r'^early_recall/(?P<pk>\d+)', views.early_recall, name='early_recall'),
    ...
    url(r'^retire_equipment/(?P<pk>\d+)', views.retire_equipment, name='retire_equipment'),

    # url(r'^addincident/', views.add_incident, name='addincident')
]
